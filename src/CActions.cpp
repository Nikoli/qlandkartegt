...
#ifdef HAS_POWERDB
    createAction(tr("F11"), ":/icons/iconPower16x16.png", tr("Electr&ic"), "aSwitchToElectric", tr("Electric distribution network."));
#endif
...
void CActions::funcToggleMap()
{
    CMapDB::self().getMap().toggleRotate();
}
