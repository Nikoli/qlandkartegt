...
set QLGTI_VCREDIST_PATH="C:\Dokumente und Einstellungen\cad\Eigene Dateien\QLGT-PN\qlandkartegt-pn-1.1.4\Win32"
set QLGTI_LIBEXIF_PATH="E:\qlgt\tools\libexif"
set QLGTI_GDAL_PATH="%CD%\..\Win32\gdal\bin"
set QLGTI_SOURCE_PATH="C:\Dokumente und Einstellungen\cad\Eigene Dateien\QLGT-PN\qlandkartegt-pn-1.1.4"
set QLGTI_BUILD_PATH="C:\Dokumente und Einstellungen\cad\Eigene Dateien\QLGT-PN\qlandkartegt-pn-1.1.4-build"
